<div class="flex flex-col sm:flex-row gap-4 justify-center">
  ...
  >
    ...
    <span class="text-gray-300 transition-colors group-hover:text-white">GitHub</span>
  </a>
  ...
  >
    ...
    <span class="text-gray-300 transition-colors group-hover:text-white">Email</span>
  </a>
</div>
