<div class="flex flex-col sm:flex-row gap-4 justify-center">
  ...
  >
    ...
    <span class="text-[var(--surface-fg)] transition-colors group-hover:text-[var(--base-fg)]">GitHub</span>
  </a>
  ...
  >
    ...
    <span class="text-[var(--surface-fg)] transition-colors group-hover:text-[var(--base-fg)]">LinkedIn</span>
  </a>
